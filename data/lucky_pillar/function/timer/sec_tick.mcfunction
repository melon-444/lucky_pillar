...
execute as @a[team=!] if score $loot_current lp_cnt >= $loot_timer lp_cnt run loot give @s loot lucky_pillar:full_loot_table_1_21_11
execute as @a[team=!] if score $loot_current lp_cnt >= $loot_timer lp_cnt run scoreboard players set $loot_current lp_cnt 0
